...
import { getUserById, updateUser } from 'src/firebase/user';
...
export default function EditUserView() {
  ...
  const handleSubmit = async (event) => {
    ...
    showAlert('User update successfully', 'success');
  ...
  return (
    ...
    >
      ...
      <Stack alignItems="center" justifyContent="center" sx={{ height: 1 }}>
        ...
        >
          <Typography variant="h4" sx={{ mt: 2, mb: 5 }}>Edit the user</Typography>
